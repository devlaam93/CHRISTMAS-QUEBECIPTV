...
const FAQSection = () => {
  const faqs = [
    ...
    { question: "Puis-je essayer avant d'acheter?", answer: "Oui! Nous offrons un essai gratuit de 24 heures pour que vous puissiez tester la qualité de notre service avant de vous engager. Visitez notre page d'essai gratuit pour faire votre demande." },
    { question: "Qu'est-ce qui est inclus dans l'abonnement?", answer: "Tous les forfaits incluent 30 000+ chaînes en direct, 120 000+ films et séries (VOD), contenu Netflix et plateformes de streaming, chaînes sports, rattrapage TV, EPG, et support 24/7." },
  ...
  return (
    <section id="faq" className="py-24 relative bg-xmas-pattern">
